$(document).ready(function () {
	$('#data_bt').click(function () {



		alert($(this).parents('tr').find('th:nth-child(2)').data('id'))

	});
});

function fun_get_fence(on_success) {
	$.ajax({
		type: 'POST', //GET or POST
		url: "http://" + ip + "/Electronic_fence%20_advanced/area/select_area.php", //請求的頁面
		data: {
